...
class ExpiredAppointment extends ConsumerStatefulWidget {
  ...
  @override
  ExpiredAppointmentState createState() => ExpiredAppointmentState();
}

class ExpiredAppointmentState extends ConsumerState<ExpiredAppointment> {
