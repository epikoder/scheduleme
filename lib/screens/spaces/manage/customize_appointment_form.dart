...
import 'package:scheduleme/screens/spaces/manage/partials/customize_form.dart';
import 'package:scheduleme/screens/spaces/manage/state.dart';
import 'package:scheduleme/utils/toast.dart';
import 'package:styled_widget/styled_widget.dart';

class CustomizeAppointmentFormScreen extends StatefulWidget {
  const CustomizeAppointmentFormScreen(
      {super.key, required this.appointmentFormId});
  final String appointmentFormId;

  @override
  CustomizeAppointmentFormScreenState createState() =>
      CustomizeAppointmentFormScreenState();
}

class CustomizeAppointmentFormScreenState
    extends State<CustomizeAppointmentFormScreen> {
